...
import douglasspgyn.com.github.circularcountdown.OnCountdownFinish
import kotlinx.android.synthetic.main.activity_main.*

class MainActivity : AppCompatActivity(), OnCountdownFinish {
    ...
    private fun withoutLoop() {
        circularCountdownWithoutLoop.create(3, 10, CircularCountdown.TYPE_SECOND, this).loop(false).start()
    ...
    private fun withLoop() {
        circularCountdownWithInfinityLoop.create(0, 10, CircularCountdown.TYPE_SECOND, object : OnCountdownFinish {
            override fun onFinish(newCycle: Boolean, cycleCount: Int) {
    ...
    private fun withLoopDisabledBeforeRun() {
        circularCountdownWithLoopDisablingBefore.create(5, 10, CircularCountdown.TYPE_SECOND, object : OnCountdownFinish {
            override fun onFinish(newCycle: Boolean, cycleCount: Int) {
    ...
    private fun withLoopDisabledAfterRun() {
        circularCountdownWithLoopDisablingAfter.create(7, 10, CircularCountdown.TYPE_SECOND, object : OnCountdownFinish {
            override fun onFinish(newCycle: Boolean, cycleCount: Int) {
    ...
    private fun withLoopDisabledAfterThreeCycles() {
        circularCountdownWithLoopThreeCycles.create(9, 10, CircularCountdown.TYPE_SECOND, object : OnCountdownFinish {
            override fun onFinish(newCycle: Boolean, cycleCount: Int) {
    ...
    private fun withoutLoopDisabledAfterThreeCycles() {
        circularCountdownWithouthLoopThreeCycles.create(9, 10, CircularCountdown.TYPE_SECOND, object : OnCountdownFinish {
            override fun onFinish(newCycle: Boolean, cycleCount: Int) {
    ...
    private fun withoutLoopDisabledAfterThreeCycles2() {
        circularCountdownWithouthLoopThreeCycles2.create(9, 10, CircularCountdown.TYPE_SECOND, object : OnCountdownFinish {
            override fun onFinish(newCycle: Boolean, cycleCount: Int) {
                Log.d("WithoutLoopThreeCycles", "Loop: $newCycle - Cycle: $cycleCount")
            }
    ...
    private fun withoutLoopDisabledAfterCyclesUpdating() {
        withoutLoopDisabledAfterCyclesUpdating.create(9, 10, CircularCountdown.TYPE_SECOND, object : OnCountdownFinish {
            override fun onFinish(newCycle: Boolean, cycleCount: Int) {
    ...
    private fun withoutLoopDisabledAfterCyclesUpdating2() {
        withoutLoopDisabledAfterCyclesUpdating2.create(9, 10, CircularCountdown.TYPE_SECOND, object : OnCountdownFinish {
            override fun onFinish(newCycle: Boolean, cycleCount: Int) {
